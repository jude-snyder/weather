...
console.log("Here's the real temperature:", data.current.temp_f, "degrees.", "Don't get thrown off by this tho.");
console.log("And here's the temp that it really feels like 💀", data.current.feelslike_f, "degrees! How ya like that?");
